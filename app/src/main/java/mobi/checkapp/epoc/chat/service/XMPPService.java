...
import mobi.checkapp.epoc.chat.IXMPPRosterCallback;
...
public class XMPPService extends GenericService {
	...
	private static final String RECONNECT_ALARM = "mobi.checkapp.epoc.chat.RECONNECT_ALARM";
	...
	private void updateServiceNotification() {
		...
		*/
		...
		builder.setContentIntent(PendingIntent.getActivity(this, 0, notificationIntent,
				PendingIntent.FLAG_UPDATE_CURRENT))

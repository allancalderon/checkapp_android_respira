package mobi.checkapp.epoc.chat.dialogs;
...
import mobi.checkapp.epoc.chat.XMPPRosterServiceAdapter;
...
public class ChangePasswordDialog extends AlertDialog implements
	...
	public void onCreate(Bundle icicle) {
		...
		serviceIntent.setAction("mobi.checkapp.epoc.chat.XMPPSERVICE");

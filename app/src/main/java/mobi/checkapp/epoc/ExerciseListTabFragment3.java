 ...
 */
public class ExerciseListTabFragment3 extends Fragment implements ExpandableListView.OnChildClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (CacheMainActivity.recommendedExercisesList == null)
            Utils.loadExercisesInfoFromXml(context, getResources(), TAG);
        setupExpandableList();
